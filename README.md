...
A Quest-native (i.e. OpenXR, without a third-party game engine) port of the [Azahar 3DS emulator](https://github.com/azahar-emu/azahar). It began as CitraVR and still preserves that Quest-focused VR design.
